...
METIERS = {
    "boulangerie": dict(
        ...
        photo_alt="Main de boulanger saisissant un pain à la pince devant les corbeilles de la vitrine",
    ...
    "patisserie": dict(
        ...
        photo_alt="Mains de pâtissier dressant la crème à la poche sur un gâteau",
    ...
    "traiteur": dict(
        ...
        photo_alt="Mains gantées d'un traiteur dressant les parts dans un plat",
