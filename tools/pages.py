...
METIERS = {
    ...
    "patisserie": dict(
        ...
        photo_alt="Une pâtissière décore un gâteau à la poche dans son laboratoire",
    ...
    "chocolaterie": dict(
        ...
        photo_alt="Un chocolatier pèse et garnit des tablettes sur son plan de travail",
    ...
    "charcuterie": dict(
        ...
        photo_alt="Deux charcutiers derrière la vitrine réfrigérée de leur comptoir",
    ...
    "poissonnerie": dict(
        ...
        photo_alt="Des poissonniers servent les clients derrière leur étal sur glace",
    ...
    "traiteur": dict(
        ...
        photo_alt="Un traiteur découpe le jambon au couteau devant un buffet dressé",
